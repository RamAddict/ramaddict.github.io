...
<template>
  <div
    :class="`relative mx-auto flex max-w-fit cursor-pointer flex-row items-center justify-center overflow-hidden
      rounded-[1.25rem] font-medium backdrop-blur transition-shadow duration-500 ${className}`"
  >
    <div
      v-if="showBorder"
    ...
    <div
      class="z-2 animate-gradient relative inline-block bg-cover text-transparent"
      :style="textStyle"
    >
      {{ text }}
    </div>
